...
async function testInvoice(filename) {
    console.log(`\n=== Testing: ${filename} ===\n`);
    ...
    console.log('Total-related lines:');
    ...
    console.log('\nParsed Result:');
    console.log(`  Tax Number: ${taxRecord.tax_invoice_number}`);
...
async function main() {
    // Test invoice with empty total
    await testInvoice('/Users/qichao/invoice/test_data/Fatura FT OM.2026_5 Original.pdf');

    // Test a working invoice for comparison
    await testInvoice('/Users/qichao/invoice/test_data/Fatura FT OM.2026_1 Original.pdf');
}
